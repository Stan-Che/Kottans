	...
	render() {
		return (
			<Deck transitionDuration={500} theme={theme}>
				...
				<Slide transition={["fade"]} bgColor="primary">
					<Heading size={3} lineHeight={2}>Стас Чернецкий</Heading>
				...
				<Slide transition={["fade"]} bgColor="primary" textColor="tertiary">
					<Image
						src={'https://media0.giphy.com/media/BQAk13taTaKYw/giphy.gif'}
						width={450}
						height={250}
					/>
				...
				<Slide transition={["fade"]} bgColor="primary" textColor="tertiary">
					<Image
						src={'https://static.devli.ru/public/images/gifs/201304/07a3eb01-3cc0-4059-8b30-caed3aba391e.gif'}
						width={400}
						height={250}
					/>
				...
				<Slide transition={["fade"]} bgColor="secondary" textColor="tertiary">
					<Image
						src={'https://media3.giphy.com/media/Lopx9eUi34rbq/giphy.gif'}
						width={450}
						height={250}
					/>
				...
				<Slide transition={["fade"]} bgColor="primary" textColor="tertiary">
					...
					<Image
						src={'http://static.devli.ru/public/images/gifs/201709/8e2bbba9-68b2-41ee-abef-6b1ed1a0d1e0.gif'}
						width={300}
						height={400}
					/>
				</Slide>
				...
				<Slide transition={["fade"]} bgColor="primary" textColor="tertiary">
					...
					<Image
						src={'https://static.devli.ru/public/images/gifs/201304/e83a10e1-e9a1-48b7-96e1-93a35ee70fd6.gif'}
						width={250}
						height={400}
					/>
				</Slide>
